...
int main()
{
    ...
    struct aluno a3 = {5,"Amanda",8.5,5.8,9.5};
    struct aluno a4 = {6,"Jose",6.5,9.8,7.5};
    ...
    struct aluno al2 = {7,"Nicolli",9.5,6.8,5.5};
